 ...
 */
package com.example.krngrvr09.instatime.format;
...
public class SimpleTimeFormat implements TimeFormat
{
   ...
   public String decorate(Duration duration, String time)
   {
      ...
      else
      {
       ...
       Log.d("where","decorate "+result.toString().replaceAll("\\s+", " ").trim());
