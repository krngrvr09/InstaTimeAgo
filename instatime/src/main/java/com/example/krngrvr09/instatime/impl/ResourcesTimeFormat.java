package com.example.krngrvr09.instatime.impl;
...
import com.example.krngrvr09.instatime.LocaleAware;
...
public class ResourcesTimeFormat extends SimpleTimeFormat implements TimeFormat, LocaleAware<ResourcesTimeFormat>
{
   ...
   {
       Log.d("where", "decorate(Duration Time)");
   ...
   {
       Log.d("where", "decorateUnrounded(Duration Time)");
