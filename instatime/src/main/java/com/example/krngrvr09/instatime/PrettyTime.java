...
import com.example.krngrvr09.instatime.impl.DurationImpl;
import com.example.krngrvr09.instatime.impl.ResourcesTimeFormat;
import com.example.krngrvr09.instatime.impl.ResourcesTimeUnit;
import com.example.krngrvr09.instatime.units.Century;
import com.example.krngrvr09.instatime.units.Day;
import com.example.krngrvr09.instatime.units.Decade;
import com.example.krngrvr09.instatime.units.Hour;
import com.example.krngrvr09.instatime.units.JustNow;
import com.example.krngrvr09.instatime.units.Millennium;
import com.example.krngrvr09.instatime.units.Millisecond;
import com.example.krngrvr09.instatime.units.Minute;
import com.example.krngrvr09.instatime.units.Month;
import com.example.krngrvr09.instatime.units.Second;
import com.example.krngrvr09.instatime.units.TimeUnitComparator;
import com.example.krngrvr09.instatime.units.Week;
import com.example.krngrvr09.instatime.units.Year;
...
public class PrettyTime
{
  ...
  private List<TimeUnit> mCachedUnits;
   ...
   public PrettyTime()
   {
       Log.d("where", "PrettyTime()");
       //Log.d("automatic",String.valueOf(this.getClass().getEnclosingMethod().getName()));
       initTimeUnits();
   }
   ...
   {
      this();
       Log.d("automatic", String.valueOf(Thread.currentThread().getStackTrace()[1].getMethodName()));
       Log.d("where", "PrettyTime(Date)");
   ...
   {
      this(locale);
       Log.d("where", "PrettyTime(Date, Locale)");
   ...
   {
       Log.d("where", "approximateDuration()");
   ...
   {
       Log.d("where", "calculateduration");

       long absoluteDifference = Math.abs(difference);
       Log.d("wereabsdiff", String.valueOf(absoluteDifference));
      ...
      for (int i = 0; i < localUnits.size(); i++)
      {
       ...
       Log.d("whereresult", String.valueOf(result));
      return result;
   }
   ...
   {
       Log.d("where", "calculatepreciseduration");
   ...
   {
       Log.d("where", "formatUnrounded(Duration)");
   ...
   {
       Log.d("where", "formatUnrounded(ListDuration(");
   ...
   public String formatApproximateDuration(Date date) {
       Log.d("where", "formatApproximateDuration");
   ...
   public String formatDuration(Duration duration) {
       Log.d("where", "formatDuration(Duration)");
   ...
   {Log.d("where", "getFormat(TimeUnit)");
   ...
   {
       Log.d("where", "registerUnit(TimeUNit,TimeFormat)");
   ...
   {
       Log.d("where", "removeUnit(TimeUnit)");
